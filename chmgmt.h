...
#define MAX_CH_DATA_BUFLEN	600
#define MAX_CH_NUM	254
...
#define LO160_SB(channel)	(((channel) > (CH_APART_10M + CH_APART_40M)) ? ((channel) - (CH_APART_10M + CH_APART_40M)) : 0)
#define UP160_SB(channel)	(((channel) < (MAX_CH_NUM - (CH_APART_10M + CH_APART_40M))) ? ((channel) + (CH_APART_10M + CH_APART_40M)) : 0)

#define LL160_SB(channel)	(((channel) > (CH_APART_10M + CH_APART_20M + CH_APART_40M)) ? ((channel) - (CH_APART_10M + CH_APART_20M + CH_APART_40M)) : 0)
#define UU160_SB(channel)	(((channel) < (MAX_CH_NUM - (CH_APART_10M + CH_APART_20M + CH_APART_40M))) ? ((channel) + (CH_APART_10M + CH_APART_20M + CH_APART_40M)) : 0)
#define LU160_SB(channel)	LO160_SB(channel)
#define UL160_SB(channel)	UP160_SB(channel)
