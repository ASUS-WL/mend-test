...
#define DEBUG_ERR(__TITLE__,...)		AdvDBG_ODS(ADVDBG_ERR,"%s[%s(%d)]:%s\n",((__TITLE__==NULL)?"":__TITLE__),__FUNCTION__,__LINE__,__VA_ARGS__);
#define DEBUG_INFO(__TITLE__,...)		AdvDBG_ODS(ADVDBG_INFO,"%s[%s(%d)]:%s\n",((__TITLE__==NULL)?"":__TITLE__),__FUNCTION__,__LINE__,__VA_ARGS__);
...
#define DEBUG_WARNING(__TITLE__,...)	AdvDBG_ODS(ADVDBG_WARNING,"%s[%s(LINE:%d)]:%s\n",((__TITLE__==NULL)?"":__TITLE__),__FUNCTION__,__LINE__,__VA_ARGS__);
#define DEBUG_PRINTF(__TITLE__,...)		AdvDBG_ODS(ADVDBG_INFO,"%s",__VA_ARGS__);
